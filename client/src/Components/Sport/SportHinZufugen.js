...
import { sportArtHinzufugen } from "../../Redux/actions/SportArtActions";
export default class SportHinZufugen extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <div>
        ...
        <button className="registerbtn">Sportart hinzufügen</button>
      </div>
    );
  }
}
